...
```
<iframe src="https://nextjs-fast-feedback.vercel.app/embed/SITE_ID" />
```
...
```
<iframe src="https://nextjs-fast-feedback.vercel.app/embed/SITE_ID/ROUTE" />
```
...
<IframeResizer
  checkOrigin={false}
  title="Comments"
  src={`https://nextjs-fast-feedback.vercel.app/embed/SITE_ID`}
  style={{
    width: '1px',
    minWidth: '100%'
  }}
...
function Feedback () {
  const API = 'https://nextjs-fast-feedback.vercel.app/api/feedback/SITE_ID';
